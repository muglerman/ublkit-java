...
3. **ERROR**
   - **Validación:** El formato del Tag UBL no tiene el formato:<br>- [B][A-Z0-9]{3}-[0-9]{1,8}<br>- [0-9]{1,4}-[0-9]{1,8}
...
6. **ERROR**
   - **Validación:** Si la serie empieza con número, y el valor del Tag UBL se encuentra en el listado, y el comprobante ha sido informado en un Resumen Diario.<br>Validación no aplica para OSE
...
1. **OBSERV**
   ...
   - **Listados:** -
## 7. Tipo de moneda en la cual se emite la boleta de venta electrónica
...
5. **ERROR**
   - **Validación:** Si 'Tipo de operación' es '0201 Exportación de Servicios – Prestación servicios realizados íntegramente en el país', no existe ind_padrón igual a "05" en el listado para el valor del Tag UBL
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @listName es incorrecto.
   - **Listados:** -
## 14. Código de país del uso, explotación o aprovechamiento del servicio
...
1. **ERROR**
   - **Validación:** Si 'Tipo de operación' es '0201' o '0208', y el Tag UBL no existe o es vacio.
...
1. **OBSERV**
   - **Validación:** Si no existe el Tag UBL o es vacío
   - **Mensaje:** El XML no contiene el tag o no existe información del código de local anexo del emisor

2. **OBSERV**
   - **Validación:** Si el Tag UBL existe y es diferente de vacío y es diferente de '0000', el valor del Tag UBL no está en el listado
...
## 16. Tipo y número de documento de identidad del adquirente o usuario
...
2. **ERROR**
   - **Validación:** Si 'Tipo de operación' es "0200" o "0201" o "0203" o "0204" o "0205" o "0206" o "0207", "0208" o "0401", el valor del Tag UBL es  6-RUC
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @schemeURI es incorrecto.
   - **Listados:** -
## 17. Apellidos y nombres, denominación o razón social del adquirente o usuario
...
2. **ERROR**
   ...
   - **Listados:** -
## 18. Dirección del adquirente o usuario
...
1. **-**
   ...
   - **Mensaje:** -
   - **Listados:** -
## 19. Tipo y número de documento de identidad de otros participantes asociados a la transacción<br>Apellidos y nombres, denominación o razón social de otros participantes asociados a la transacción
...
1. **-**
   ...
   - **Mensaje:** -
   - **Listados:** -
## 20. Dirección en el país o lugar de destino

- **Nivel:** Global
- **Condición informática:** C
- **Tipo y longitud:** an..200
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cac:AddressLine/cbc:Line<br>(Dirección completa y detallada)
...
- **Condición informática:** C
- **Tipo y longitud:** an..25
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cbc:CitySubdivisionName (Urbanización)
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cbc:CityName (Provincia)
...
- **Tipo y longitud:** an6
- **Formato / Valor:** (Catálogo N.° 13)
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cbc:ID (Código de ubigeo)
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cbc:CountrySubentity (Departamento)
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cbc:District (Distrito)
...
- **Tipo y longitud:** an2
- **Formato / Valor:** (Catálogo N.° 04)
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cac:PhysicalLocation/cac:Address/cac:Country/cbc:IdentificationCode (Código de país)
...
1. **-**
   ...
   - **Mensaje:** -
   - **Listados:** -
## 21. Código de usuario de Zofratacna

- **Nivel:** Global
- **Condición informática:** C
- **Tipo y longitud:** an..20
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cbc:AdditionalAccountID
...
- **Condición informática:** C
- **Tipo y longitud:** an1
- **Formato / Valor:** "1" - Zofratacna
- **Tag:** /Invoice/cac:AccountingCustomerParty/cac:Party/cbc:AdditionalAccountID@schemeID (Tipo de registro)
...
- **Formato / Valor:** -
- **Tag:** -
## 22. Tipo y número de la guía de remisión relacionada con la operación
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:AdditionalDocumentReference/cbc:ID (Número de documento relacionado)
- **Uso del campo:** 1
...
1. **OBSERV**
   - **Validación:** Si existe el "Número de otro documento relacionado", el formato del Tag UBL es diferente de  '02', '03', '04', '05', '08', '09', '99'
...
- **Tag:** /Invoice/cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cbc:ID
- **Uso del campo:** 1
...
1. **OBSERV**
   ...
   - **Listados:** -
## 30. Descripción detallada del servicio prestado, bien vendido o cedido en uso, indicando las características
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda debe ser la misma en todo el documento. Salvo las percepciones que sólo son en moneda nacional
   - **Listados:** Catálogo<br>(002)
## 32. Precio de venta unitario por ítem
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @listURI es incorrecto.
   - **Listados:** -
## 33. Valor referencial unitario por ítem en operaciones gratuitas (no onerosas)
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @listURI es incorrecto.
   - **Listados:** -
## 34. Monto total de tributos del ítem
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda debe ser la misma en todo el documento. Salvo las percepciones que sólo son en moneda nacional
   - **Listados:** Catálogo<br>(002)
## 35. Afectación al IGV por ítem<br>Afectación IVAP por ítem

- **Nivel:** Ítem
- **Condición informática:** M
- **Tipo y longitud:** an..15
- **Formato / Valor:** n(12,2)
- **Tag:** /Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount (Monto base IGV o IVAP)
- **Uso del campo:** 0..1
...
2. **OBSERV**
   - **Validación:** Si existe en la línea misma línea un cac:TaxSubtotal con 'Código de tributo por línea' igual a '2000' cuyo 'Monto base' es mayor a cero (cbc:TaxableAmount > 0), el valor del tag es diferente de la suma del 'Valor de venta del ítem' más el 'Monto del tributo de la línea del ISC', con una tolerancia + - 1
   - **Mensaje:** La base imponible a nivel de línea difiere de la información consignada en el comprobante
   - **Listados:** -

3. **OBSERV**
   - **Validación:** Si no existe en la misma línea un cac:TaxSubtotal con 'Código de tributo por línea' igual a '2000' cuyo 'Monto base' es mayor a cero (cbc:TaxableAmount > 0), el valor del tag es diferente del 'Valor de Venta del ítem'
   - **Mensaje:** La base imponible a nivel de línea difiere de la información consignada en el comprobante
   - **Listados:** -
## 35. Afectación al IGV por ítem<br>Afectación IVAP por ítem
...
- **Tipo y longitud:** an..15
- **Formato / Valor:** n(12,2)
- **Tag:** /Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount (Monto de IGV o IVAP de la línea)
- **Uso del campo:** 1
...
5. **ERROR**
   - **Validación:** Si 'Código de tributo por línea' es igual a '1000' o '1016' y<br>'Monto base' mayor a 'seis centésimas' (cbc:TaxableAmount > 0.06) y 'Tipo de operación' es diferente de '0113' , el valor del tag UBL es igual a 0
   - **Mensaje:** El monto de afectación de IGV por linea debe ser diferente a 0.00.
   - **Listados:** -

6. **ERROR**
   - **Validación:** Si 'Afectación al IGV o IVAP' es '10','11', '12', '13', '14', '15', '16' o '17', el valor del tag es diferente a la tasa del tributo por el 'Monto base IGV o IVAP de la línea' (con una tolerancia + - 1)
...
4. **ERROR**
   - **Validación:** Si 'Código de tributo por línea' es igual a '1000' o '1016', y  'Monto base' mayor a cero (cbc:TaxableAmount > 0), y 'Tipo de operación' es diferente de '0113'  el valor del tag UBL es igual a 0
   - **Mensaje:** El factor de afectación de IGV por linea debe ser diferente a 0.00.
   - **Listados:** -
## 35. Afectación al IGV por ítem<br>Afectación IVAP por ítem
...
5. **ERROR**
   - **Validación:** Si 'Afectación al IGV o IVAP' es '17' y  'Monto base' es mayor a cero, y existe otra línea con 'Afectación al IGV o IVAP' diferente de '17' y 'Monto base' mayor a cero
...
4. **ERROR**
   - **Validación:** Si 'Tipo de operación' es diferente de '2100', '2101', '2102', '2103' y '2104', y no existe en el ítem un cac:TaxSubtotal con monto base mayor a cero (cbc:TaxableAmount > 0) y cbc:ID con alguno de los siguientes valores: '1000', '1016', '9995', '9996', '9997' o '9998'
...
1. **ERROR**
   ...
   - **Listados:** Catálogo<br>(005)
## 36. Sistema de ISC por ítem<br>Afectacion otros tributos por ítem
...
1. **ERROR**
   ...
   - **Mensaje:** El Name o TaxTypeCode debe corresponder al codigo de tributo del item
   - **Listados:** Catálogo<br>(005)
## 37. Impuesto al consumo de bolsas de plástico por ítem

- **Nivel:** Ítem
- **Condición informática:** C
- **Tipo y longitud:** an..15
- **Formato / Valor:** n(12,2)
- **Tag:** /Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount (Monto de tributo por línea)
- **Uso del campo:** 1
...
1. **ERROR**
   - **Validación:** Si 'Tipo de operación' es 0113-Venta Interna NRUS y valor del tag UBL es mayor a cero
   - **Mensaje:** El impuesto ICBPER no aplica para el NRUS
   - **Listados:** -
## 37. Impuesto al consumo de bolsas de plástico por ítem
...
- **Tipo y longitud:** an5
- **Formato / Valor:** n5
- **Tag:** /Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:BaseUnitMeasure (Cantidad de bolsas plásticas)
...
1. **OBSERV**
   - **Validación:** Si el atributo existe, el valor es diferente de 'NIU'
   - **Mensaje:** El dato ingresado como unidad de medida no corresponde al valor esperado
   - **Listados:** -
## 37. Impuesto al consumo de bolsas de plástico por ítem
...
3. **OBSERV**
   - **Validación:** Si 'Código de tributo por línea' es igual a '7152' y 'Cantidad de bolsas de plástico' es mayor a cero (cbc:BaseUnitMeasure > 0) y 'Tipo de moneda  en la cual se emite la boleta de venta  electrónica' es igual a 'PEN', el valor del tag UBL es diferente de la tasa vigente de ICBPER a la fecha de emisión
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda debe ser la misma en todo el documento. Salvo las percepciones que sólo son en moneda nacional
   - **Listados:** Catálogo<br>(002)
## Totales de la boleta de venta. Registro Totales de la boleta de venta
...
2. **ERROR**
   ...
   - **Listados:** Catálogo<br>(005)
## 44. Total valor de venta - operaciones gratuitas<br>Sumatoria de tributos de operaciones gratuitas
...
4. **ERROR**
   - **Validación:** Si 'Código de tipo de tributo' es 9996 (Gratuita) y 'Código de leyenda' es '1002', el valor del Tag UBL es igual a 0 (cero)
...
2. **ERROR**
   ...
   - **Mensaje:** El valor del tag codigo de tributo internacional no corresponde al esperado.
   - **Listados:** Catálogo<br>(005)
## 45<br>46. Total valor de venta - operaciones gravadas (IGV o IVAP)<br>Sumatoria IGV o IVAP
...
2. **OBSERV**
   - **Validación:** Si  'Código de tributo' es '1000' y 'Tipo de operación' es diferente a '0113', el valor del Tag UBL es diferente al resultado de multiplicar la sumatoria de los 'Monto base' de las líneas (cbc:TaxableAmount) con 'Código de tributo por línea' igual a '1000', menos 'Monto de descuentos' globales que afectan la base (Código '02' y '04'), más los 'Montos de cargos' globales que afectan la base (Código 49), menos los 'anticipos ISC' (Codigo 20) por la tasa vigente al IGV (18.00 o 10.50) a la fecha de emisión, con una tolerancia + - 1
   - **Mensaje:** El cálculo del IGV es Incorrecto
   - **Listados:** -

3. **ERROR**
   - **Validación:** Si 'Tipo de operación' es diferente a '0113', y existe alguna línea con ('Código de tributo por línea' igual a '1000' y 'Monto base' (cbc:TaxableAmount) mayor a cero) o ('Código de tributo por línea' igual a '9996' y 'Afectación del IGV por ítem' igual a '11', '12', '13', '14', '15' o '16' y 'Monto base' (cbc:TaxableAmount) mayor a cero), y diferente tasa de tributo (cbc:Percent)<br>*Nota: Todas las líneas afectas al IGV deben tener la misma tasa vigente.
...
2. **ERROR**
   ...
   - **Mensaje:** El valor del tag codigo de tributo internacional no corresponde al esperado.
   - **Listados:** Catálogo<br>(005)
## 47<br>48<br>49. Sumatoria ISC<br>Sumatoria otros tributos<br>Sumatoria ICBPER
...
4. **OBSERV**
   - **Validación:** Si existe el Tag y el 'Código de tributo' es '9999', el valor del Tag UBL es diferente a la sumatoria de los 'Monto base' (cbc:TaxableAmount) de los ítems con 'Código de tributo por línea' igual a '9999' (con una tolerancia + - 1)
...
5. **OBSERV**
   - **Validación:** Si  'Código de tributo' es '9999', el valor del Tag Ubl  y es diferente de la sumatoria de los importes de otros tributos (cbc:TaxAmount) con 'Código de tributo por línea' igual a '9999' de cada ítem (con una tolerancia + - 1)
...
5. **ERROR**
   - **Validación:** Si 'Código de tributo' es '2000' y 'Monto base' es mayor a cero, y existe una línea con código de 'Afectación al IGV o IVAP' con valor '17' (IVAP) cuyo 'Monto base' es mayor a cero (cbc:TaxableAmount > 0)
...
- **Tipo y longitud:** an2
- **Formato / Valor:** (Catálogo N.° 53)
- **Tag:** /Invoice/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode (Código del motivo del cargo/descuento)
- **Uso del campo:** 1
...
2. **OBSERV**
   - **Validación:** El valor del tag es diferente a la sumatoria de los 'Montos de descuentos' de línea que no afectan la base (con 'Código de motivo de descuento' igual a '01') y los 'Montos de descuentos' globales que no afectan la base (con 'Código de motivo de descuento' igual a'03'), con una tolerancia de + - 1
...
2. **OBSERV**
   - **Validación:** Si el valor del tag difiere de la sumatoria del 'Subtotal de la boleta de venta' más 'Sumatoria otros cargos (que no afectan la base imponible del IGV)' menos 'Sumatoria otros descuentos (que no afectan la base imponible del IGV)'  menos 'Total de anticipos' de corresponder y más 'Monto de redondeo del importe total',  con una tolerancia + - 1.
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda debe ser la misma en todo el documento. Salvo las percepciones que sólo son en moneda nacional
   - **Listados:** Catálogo<br>(002)
## 55. Subtotal de la boleta de venta
...
1. **ERROR**
   - **Validación:** Si no existe el atributo
...
1. **OBSERV**
   ...
   - **Listados:** -
## 59. FISE (Ley N.° 29852) Fondo de Inclusión Social Energético
...
1. **ERROR**
   - **Validación:** Si valor del tag es diferente 'true' para código de cargo/descuento igual a '45'
   - **Mensaje:** El dato ingresado como indicador de cargo/descuento no corresponde al valor esperado.
   - **Listados:** -
## 59. FISE (Ley N.° 29852) Fondo de Inclusión Social Energético
...
- **Tipo y longitud:** an..15
- **Formato / Valor:** n(12,2)
- **Tag:** /Invoice/cac:AllowanceCharge/cbc:Amount (Monto del cargo/descuento)
- **Uso del campo:** 1
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda debe ser la misma en todo el documento. Salvo las percepciones que sólo son en moneda nacional
   - **Listados:** Catálogo<br>(002)
## 60. Restitución Simplificada de Derechos Arancelarios
...
## 62. Monto de la percepción en moneda nacional
...
1. **ERROR**
   - **Validación:** Si valor del tag es diferente 'true' para código de cargo/descuento igual a '51' o '52' o '53'
   - **Mensaje:** El dato ingresado como indicador de cargo/descuento no corresponde al valor esperado.
   - **Listados:** -
## 62. Monto de la percepción en moneda nacional
...
3. **ERROR**
   - **Validación:** Si 'Tipo de operación' es '2001 - Operación Sujeta a Percepción', no existe un 'Código de motivo de cargo/descuento' igual a '51' o '52' o '53'
...
- **Tipo y longitud:** an..9
- **Formato / Valor:** n(3,5)
- **Tag:** /Invoice/cac:AllowanceCharge/cbc:MultiplierFactorNumeric (Factor de cargo/descuento: Tasa percepción expresado como factor)
- **Uso del campo:** 0..1
...
2. **ERROR**
   - **Validación:** Si 'Código de motivo de cargo/descuento' es '51' o '52' o '53' (Percepción), el valor del Tag UBL es diferente a  'Base imponible percepción' * 'Factor de cargo/descuento', con una tolerancia + -1
...
1. **ERROR**
   - **Validación:** Si 'Tipo de operación' es '2001 - Operación Sujeta a Percepción', y no existe un cac:PaymentTerms con cbc:ID con valor igual a 'Percepcion'
...
2. **ERROR**
   - **Validación:** Si existe más de 'Identificador de pago' con el mismo valor
...
1. **ERROR**
   - **Validación:** Si 'Tipo de comprobante que se realizó el anticipo' es '02' o '03', y no existe un 'Monto anticipado' con 'Identificador de pago' igual al valor del tag UBL
...
3. **ERROR**
   - **Validación:** Si existe identificador de pago (cbc:DocumentStatusCode) y 'Serie del comprobante que realizó el anticipo' empieza con B o F o E, y RUC del emisor del anticipo es igual al RUC emisor de la boleta, la 'Serie y número del comprobante que realizó el anticipo' no existe con estado activo en el listado para el RUC consignado en el emisor del anticipo
   - **Mensaje:** El comprobante que se realizo el anticipo no existe
   - **Listados:** Comprobantes de pago electrónico

4. **OBSERV**
   - **Validación:** Si existe identificador de pago (cbc:DocumentStatusCode) y 'Serie del comprobante que realizó el anticipo' empieza con número, y RUC del emisor del anticipo es igual al RUC emisor de la boleta, la 'Serie y número del comprobante que realizó el anticipo' no existe en el listado para el RUC consignado en el emisor del anticipo
...
1. **ERROR**
   - **Validación:** Si existe Tag UBL con valor mayor a cero, la suma de los 'Monto anticipado' es diferente al valor del tag UBL
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda debe ser la misma en todo el documento. Salvo las percepciones que sólo son en moneda nacional
   - **Listados:** Catálogo<br>(002)
## Información adicional - boleta de venta que sustenta traslado. Registro Información adicional - boleta de venta que sustenta traslado
## 66. Dirección punto de llegada - Código de ubigeo

- **Nivel:** Global
- **Condición informática:** C
- **Tipo y longitud:** n6
- **Formato / Valor:** (Catálogo N.° 13)
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cbc:ID (Código de ubigeo)
- **Uso del campo:** 0..1
...
- **Condición informática:** C
- **Tipo y longitud:** an..200
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cac:AddressLine/cbc:Line (Dirección completa y detallada)
- **Uso del campo:** 1
...
- **Condición informática:** C
- **Tipo y longitud:** an..25
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cbc:CitySubdivisionName (Urbanización)
- **Uso del campo:** 0..1
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cbc:CityName (Provincia)
- **Uso del campo:** 0..1
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cbc:CountrySubentity (Departamento)
- **Uso del campo:** 0..1
...
- **Condición informática:** C
- **Tipo y longitud:** an..30
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cbc:District (Distrito)
- **Uso del campo:** 1
...
- **Tipo y longitud:** an2
- **Formato / Valor:** (Catálogo N.° 04)
- **Tag:** /Invoice/cac:Delivery/cac:Shipment/cac:Delivery/cac:DeliveryAddress/cac:Country/cbc:IdentificationCode (Código de país)
- **Uso del campo:** 0..1
...
- **Formato / Valor:** -
- **Tag:** -
## 67<br>68<br>69<br>70<br>71<br>72<br>73. Número de asiento<br>Información de manifiesto de pasajeros<br>Número de documento de identidad del pasajero<br>Tipo de documento de identidad del pasajero<br>Nombres y apellidos del pasajero<br>Ciudad o lugar de destino<br>Ciudad o lugar de origen
...
- **Tipo y longitud:** an6
- **Formato / Valor:** (Catálogo N.° 13)
- **Tag:** /Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Value (Ciudad o lugar de destino - Código de ubigeo)
- **Uso del campo:** 1
...
## 76<br>77. Lugar de origen<br>Lugar de destino
...
1. **ERROR**
   - **Validación:** De existir 'Código del concepto' igual a '4030', '4031', '4032' o '4033' y no existe el tag o es vacío.
   - **Mensaje:** El XML no contiene tag o no existe información del valor del concepto por linea.
   - **Listados:** -
...
## 78. Número de RUC del Agente de Ventas
...
1. **ERROR**
   ...
   - **Listados:** -
## 79. Tipo de documento del Agente de Ventas
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @schemeURI es incorrecto.
   - **Listados:** -
## 80<br>81<br>82<br>83<br>84. Pasajero - Apellidos y Nombres<br>Pasajero - Tipo y número de documento de identidad<br>Servicio de transporte: Ciudad o lugar de origen<br>Servicio de transporte: Ciudad o lugar de destino<br>Servicio de transporte: Número de asiento
...
1. **ERROR**
   - **Validación:** De existir 'Código del concepto' igual a '4040', '4041', '4042', '4043', '4044', '4045' o '4046' o '4049' y no existe el tag o es vacío.
   - **Mensaje:** El XML no contiene tag o no existe información del valor del concepto por linea.
   - **Listados:** -

2. **OBSERV**
   - **Validación:** Si el 'Código del concepto' es '4040' y el valor del tag es diferente a alfanumérico de 3 hasta 200 caracteres (se considera cualquier carácter incluido espacio, no se permite ningún otro "whitespace character": salto de línea, tab, fin de línea, etc.)
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
...
9. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
## 85. Servicio de transporte: Fecha programado de inicio de viaje
...
1. **ERROR**
   ...
   - **Mensaje:** El XML no contiene tag de la fecha del concepto por linea.
   - **Listados:** -
## 86. Servicio de transporte: Hora programada de inicio de viaje
...
1. **ERROR**
   ...
   - **Mensaje:** El XML no contiene tag de la Hora del concepto por linea.
   - **Listados:** -
## 87. Servicio de transporte: Forma de pago
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @listURI es incorrecto.
   - **Listados:** -
## 88. Servicio de transporte: Número de autorización de la transacción y el sistema de tarjeta de crédito y/o débito
...
## 89<br>90<br>91<br>92. Número de expediente<br>Código de unidad ejecutora<br>Número de contrato<br>Número de proceso de selección
...
- **Tag:** /Invoice/cac:PaymentTerms/cbc:PaymentMeansID (Código del bien o servicio)
- **Uso del campo:** 1
...
1. **OBSERV**
   - **Validación:** Si existe el tag, el valor ingresado es diferente a 'Codigo de detraccion'
   - **Mensaje:** El dato ingresado como atributo @schemeName es incorrecto.
   - **Listados:** -
## 93. Código del bien o servicio sujeto a detracción
...
1. **OBSERV**
   - **Validación:** Si existe el tag, el valor ingresado es diferente a 'urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo54'
   - **Mensaje:** El dato ingresado como atributo @schemeURI es incorrecto.
   - **Listados:** -
...
- **Condición informática:** C
- **Tipo y longitud:** an..100
- **Tag:** /Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID
- **Uso del campo:** 1
...
1. **OBSERV**
   - **Validación:** Si existe el tag, el valor ingresado es diferente a 'Medio de pago'
   - **Mensaje:** El dato ingresado como atributo @listName es incorrecto.
   - **Listados:** -
## 94. Número de cuenta en el Banco de la Nación
...
1. **OBSERV**
   - **Validación:** Si existe el tag, el valor ingresado es diferente a 'urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo59'
   - **Mensaje:** El dato ingresado como atributo @listURI es incorrecto.
   - **Listados:** -
## 95. Monto y porcentaje de la detracción
...
## 96<br>97<br>98<br>99. Matrícula de la embarcación pesquera<br>Nombre de la embarcación pesquera<br>Descripción del tipo de la especie vendida<br>Lugar de descarga
...
5. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
## 100. Cantidad de la especie vendida
...
1. **ERROR**
   - **Validación:** Si 'Tipo de operación' es igual a '1004', y no existe el tag o es vacío.
...
2. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como direccion completa y detallada no cumple con el formato establecido.
   - **Listados:** -
## 103. Punto de destino<br>- Código de ubigeo<br>- Dirección detallada del destino
...
2. **OBSERV**
   ...
   - **Listados:** -
## 105. Valor referencial del servicio de transporte
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda del monto de la detracción debe ser PEN
   - **Listados:** -
## 106. Valor referencial sobre la carga efectiva
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda del monto de la detracción debe ser PEN
   - **Listados:** -
## 107. Valor referencial sobre la carga útil nominal
...
1. **Validación**
   ...
   - **Mensaje:** -
   - **Listados:** -
## 111. Valor preliminar referencial sobre la carga efectiva (por el tramo virtual recorrido)
...
1. **OBSERV**
   - **Validación:** Si 'Tipo de operación' es igual a '1004' y el tag, el formato del Tag UBL es diferente de decimal (positivo mayor a cero) de 12 enteros y hasta 2 decimales
...
## 112. Configuracion vehicular del vehículo
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como atributo @listName es incorrecto.
   - **Listados:** -
## 113. Carga útil en toneladas métricas del vehículo
...
- **Tipo y longitud:** an..15
- **Formato / Valor:** n(12,2)
- **Tag:** /Invoice/cac:InvoiceLine/cac:Delivery/cac:Shipment/cac:Consignment/cac:TransportHandlingUnit/cac:MeasurementDimension/cbc:Measure (Valor de la carga en toneladas métricas)
- **Uso del campo:** 1
...
1. **OBSERV**
   - **Validación:** Si 'Tipo de operación' es igual a '1004' y el atributo existe, el valor es diferente 'TNE'
   - **Mensaje:** El dato ingresado como unidad de medida de la carga  del vehiculo no corresponde al valor esperado.
   - **Listados:** -
## 114. Carga efectiva en toneladas métricas del vehículo
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como unidad de medida de la carga  del vehiculo no corresponde al valor esperado.
   - **Listados:** -
## 115. Valor referencial por tonelada métrica
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda del monto de la detracción debe ser PEN
   - **Listados:** -
## 116. Valor preliminar referencial por carga útil nominal (tratándose de más de 1 vehículo)
...
1. **ERROR**
   ...
   - **Mensaje:** La moneda del monto de la detracción debe ser PEN
   - **Listados:** -
## 117. Indicador de aplicación de factor de retorno al vacío
...
## 118. Partida arancelaria<br>Declaración aduanera de mercancías (DAM)
...
1. **-**
   ...
   - **Mensaje:** -
   - **Listados:** -
## Información adicional  a nivel de ítem -  comprobante emitido por empresas financieras. Registro Información adicional  a nivel de ítem -  comprobante emitido por empresas financieras
## 120<br>121<br>122<br>123<br>124<br>125<br>126. Número  de contrato<br>Fecha del otorgamiento del crédito<br>Tipo de préstamo<br>Partida registral<br>Indicador de primera vivienda<br>Dirección completa del predio<br>Monto del crédito otorgado (capital)
...
1. **ERROR**
   - **Validación:** De existir 'Código del concepto' igual a '7004', '7005' o '7012' y no existe el tag o es vacío.
   - **Mensaje:** El XML no contiene tag o no existe información del valor del concepto por linea.
   - **Listados:** -
## 120<br>121<br>122<br>123<br>124<br>125<br>126. Número  de contrato<br>Fecha del otorgamiento del crédito<br>Tipo de préstamo<br>Partida registral<br>Indicador de primera vivienda<br>Dirección completa del predio<br>Monto del crédito otorgado (capital)
...
## 127<br>128<br>129. Número de póliza<br>Tipo de seguro<br>Suma asegurada / alcance de cobertura o monto
...
1. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
## 130<br>131. Fecha de inicio de vigencia de cobertura<br>Fecha de término de vigencia de cobertura
...
2. **OBSERV**
   ...
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
## Información adicional  a nivel de ítem - comprobante emitido por las AFP (colocar la información solo en el primer ítem de la boleta). Registro Información adicional  a nivel de ítem - comprobante emitido por las AFP (colocar la información solo en el primer ítem de la boleta)
## 132<br>133. Codigo unico de identificación del SPP (CUSPP)<br>Periodo
...
1. **ERROR**
   - **Validación:** Si 'Tipo de operación' es igual a '2105', y no existe el tag con valor '7017' por lo menos en una línea
   - **Mensaje:** Falta consignar informacion del CUSPP
   - **Listados:** -

2. **ERROR**
   - **Validación:** Si 'Tipo de operación' es igual a '2105', y no existe el tag con valor '7018' por lo menos en una línea
   - **Mensaje:** Falta consignar informacion del Periodo
   - **Listados:** -
## 132<br>133. Codigo unico de identificación del SPP (CUSPP)<br>Periodo
...
- **Nivel:** ítem
- **Condición informática:** C
- **Tipo y longitud:** an..12<br>an7
- **Formato / Valor:** AAAA-MM
- **Tag:** /Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Value (CUSPP)<br>/Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Value (Periodo)

### Validaciones

1. **ERROR**
   - **Validación:** De existir 'Código del concepto' igual a '7017' o '7018' y no existe el tag o es vacío
   - **Mensaje:** El XML no contiene tag o no existe información del valor del concepto por linea.
   - **Listados:** -

2. **OBSERV**
   - **Validación:** Si el 'Código del concepto' es '7017' y el valor del tag es diferente a alfanumérico de hasta 12 caracteres
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -

3. **OBSERV**
   - **Validación:** Si el 'Código del concepto' es '7018' y el formato del tag es distinto de año - mes
   - **Mensaje:** El dato ingresado como valor del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
## 134. Monto del interés moratorio de las comisiones
...
1. **ERROR**
   - **Validación:** Si 'Tipo de operación' es igual a '2105', y no existe el tag con valor '7019' por lo menos en una línea
   - **Mensaje:** Falta consignar información del monto de interes moratorio
   - **Listados:** -
## 134. Monto del interés moratorio de las comisiones
...
- **Tipo y longitud:** an..15
- **Formato / Valor:** n(12,2)
- **Tag:** /Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity (Monto del interés)

### Validaciones

1. **ERROR**
   - **Validación:** De existir 'Código del concepto' igual a '7019', no existe el tag
   - **Mensaje:** El XML no contiene tag o no existe información del valor del concepto por linea.
   - **Listados:** -

2. **OBSERV**
   - **Validación:** Si el 'Código del concepto' es '7019' y el formato del Tag UBL es diferente de decimal de 12 enteros y hasta 2 decimales
   - **Mensaje:** El dato ingresado como cantidad del concepto de la linea no cumple con el formato establecido.
   - **Listados:** -
