...
public final class ConstantesEndpoint {
    ...
    // ^ Usando URL de test común ya que la original de gre-test de Sunat suele dar problemas, pero la oficial documentada es:
    // "https://gre-test.nubefact.com/v1/clientessol/{client_id}/oauth2/token" según referencia de fractuyo.
