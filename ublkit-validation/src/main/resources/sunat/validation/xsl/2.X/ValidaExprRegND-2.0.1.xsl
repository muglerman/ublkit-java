...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:regexp="http://exslt.org/regular-expressions" xmlns:gemfunc="http://www.sunat.gob.pe/gem/functions" xmlns:func="http://exslt.org/functions" xmlns="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:sac="urn:sunat:names:specification:ubl:peru:schema:xsd:SunatAggregateComponents-1" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:dp="http://www.datapower.com/extensions" extension-element-prefixes="dp" exclude-result-prefixes="dp" version="1.0">
  ...
  <xsl:template match="/*">
    <!--  =========================================================================================================================================== Ini Variables   =========================================================================================================================================== -->
    <!-- INI SOLO_PRUEBAS -->
    <!-- <xsl:variable name="fileName" select="'20480072872-08-FG99-2075.xml'"/><xsl:variable name="numeroRuc" select="substring($fileName, 1, 11)"/><xsl:variable name="numeroSerie" select="substring($fileName, 16, 4)"/><xsl:variable name="numeroComprobante" select="substring($fileName, 21, string-length($fileName) - 24)"/> -->
    <!-- INICIO SUNAT -->
    ...
    <!-- <xsl:variable name="sumatoriaIGV"><xsl:choose><xsl:when test="cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1000']/cbc:TaxAmount"><xsl:value-of select="cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1000']/cbc:TaxAmount"/></xsl:when><xsl:otherwise><xsl:value-of select="'0'"/></xsl:otherwise></xsl:choose></xsl:variable><xsl:variable name="sumatoriaIVAP"><xsl:choose><xsl:when test="cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1016']/cbc:TaxAmount"><xsl:value-of select="cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1016']/cbc:TaxAmount"/></xsl:when><xsl:otherwise><xsl:value-of select="'0'"/></xsl:otherwise></xsl:choose></xsl:variable><xsl:variable name="sumatoriaISC"><xsl:choose><xsl:when test="cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='2000']/cbc:TaxAmount"><xsl:value-of select="cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='2000']/cbc:TaxAmount"/></xsl:when><xsl:otherwise><xsl:value-of select="'0'"/></xsl:otherwise></xsl:choose></xsl:variable><xsl:variable name="sumMontoTotalImpuestos" select="number($sumatoriaIGV) + number($sumatoriaIVAP) + number($sumatoriaISC)"/>-->
    <!--  =========================================================================================================================================== Fin Variables   =========================================================================================================================================== -->
    ...
    <!-- /DebitNote/cbc:UBLVersionID No existe el Tag UBL o es vacío ERROR 2075 -->
    <!-- /DebitNote/cbc:UBLVersionID El valor del Tag UBL es diferente de "2.1" ERROR 2074 -->
    ...
    <!-- /DebitNote/cbc:CustomizationID No existe el Tag UBL o es vacío ERROR 2073 -->
    <!-- /DebitNote/cbc:CustomizationID El valor del Tag UBL es diferente de "2.0" ERROR 2072 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cac:DiscrepancyResponse Existe más de un Tag UBL en el /DebitNote ERROR 2415 -->
    <!-- TODO para confirmar<xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'2415'" /><xsl:with-param name="node" select="cac:DiscrepancyResponse" /><xsl:with-param name="expresion" select="count(cac:DiscrepancyResponse)>1" /></xsl:call-template>-->
    <!-- /DebitNote/cac:DiscrepancyResponse/cbc:ResponseCode No existe el Tag UBL o es vacío ERROR 2128 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cac:DiscrepancyResponse/cbc:ResponseCode El Tag UBL no existe en el listado ERROR 2172 -->
    ...
    <!-- /DebitNote/cac:DiscrepancyResponse/cbc:Description No existe el Tag UBL o es vacío ERROR 2136 -->
    <!-- /DebitNote/cac:DiscrepancyResponse/cbc:Description El formato del Tag UBL es diferente a alfanumérico de 1 hasta 500 caracteres (se considera cualquier carácter excepto salto de línea.) ERROR 2135 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cbc:DocumentCurrencyCode No existe el Tag UBL o es vacío ERROR 2070 -->
    <!-- /DebitNote/cbc:DocumentCurrencyCode Si el Tag UBL existe, el valor del Tag UBL no existe en el listado ERROR 2070 -->
    ...
    <!-- /CreditNote/cbc:DocumentCurrencyCode Si el Tag UBL existe, el valor del Tag UBL no existe en el listado ERROR 3088 -->
    <xsl:call-template name="findElementInCatalog">
    ...
    <!-- /DebitNote/cbc:DocumentCurrencyCode La moneda de los totales de línea y totales de comprobantes es diferente al valor del Tag UBL ERROR 2071 -->
    <xsl:call-template name="isTrueExpresion">
      ...
      <xsl:with-param name="expresion" select="descendant::*[@currencyID != $monedaComprobante and not(ancestor-or-self::cac:RequestedMonetaryTotal/cbc:PayableRoundingAmount)]"/>
    </xsl:call-template>
	...
	<xsl:variable name="igv10" select="count(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[
	...
	<xsl:variable name="igv18" select="count(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[
	...
	<xsl:variable name="igvX" select="count(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[
	...
	<xsl:variable name="sumatoriaIndicador1" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '1000']]/cbc:TaxableAmount)"/>
	<xsl:variable name="sumatoriaIndicador2" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9996'] and cac:TaxCategory/cbc:TaxExemptionReasonCode[text() = '11' or text() = '12' or text() = '13' or text() = '14' or text() = '15' or text() = '16']]/cbc:TaxableAmount)"/>
	...
	<xsl:variable name="TasaPercent">
		<xsl:choose>
		   <xsl:when test="cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[cac:TaxScheme/cbc:ID[text() = '1000']]/cbc:Percent and cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '1000']/cbc:TaxableAmount &gt; 0">
			 <xsl:value-of select="cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[cac:TaxScheme/cbc:ID[text() = '1000']]/cbc:Percent div 100" />
		   </xsl:when>
		   <xsl:otherwise>
			 <xsl:text>0</xsl:text>
		   </xsl:otherwise>
    ...
    <!-- /DebitNote/cac:RequestedMonetaryTotal/cbc:ChargeTotalAmount  El formato del Tag UBL es diferente de decimal de 12 enteros y hasta 2 decimales ERROR   2064 -->
    ...
    <!-- /DebitNote/cac:RequestedMonetaryTotal/cbc:AllowanceTotalAmount  El formato del Tag UBL es diferente de decimal de 12 enteros y hasta 2 decimales ERROR   2064 <xsl:call-template name="validateValueTwoDecimalIfExist"><xsl:with-param name="errorCodeNotExist" select="'2064'"/><xsl:with-param name="errorCodeValidate" select="'2064'"/><xsl:with-param name="node" select="cac:RequestedMonetaryTotal/cbc:AllowanceTotalAmount"/><xsl:with-param name="isGreaterCero" select="false()"/></xsl:call-template> -->
    <!-- /DebitNote/cac:RequestedMonetaryTotal/cbc:PayableAmount El formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 2 decimales ERROR   2062 -->
  ...
  <xsl:template match="cac:AccountingSupplierParty">
    ...
    <xsl:param name="root"/>
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID No existe el Tag UBL o es vacío ERROR 2676 <xsl:call-template name="existElement"><xsl:with-param name="errorCodeNotExist" select="'2676'"/><xsl:with-param name="node" select="cac:Party/cac:PartyIdentification/cbc:ID"/></xsl:call-template>-->
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID@schemeID No existe el Tag UBL o es vacío ERROR 3029 -->
    <!-- DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID@schemeID El Tag UBL es diferente a "6" ERROR 2511 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID@schemeName Si existe el tag, el valor ingresado es diferente a 'Documento de Identidad' 	OBSERVACION 4255 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID@schemeAgencyName Si existe el tag, el valor ingresado es diferente a 'PE:SUNAT'	OBSERVACION 4256 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID@schemeURI Si existe el tag, el valor ingresado es diferente a 'urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06' 	OBSERVACION 4251 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4251'"/>
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name El valor del tag es mayor al formato establecido 	OBSERVACION 4092 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName No existe el Tag UBL o es vacío ERROR 1037 -->
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName El formato del Tag UBL es diferente a alfanumérico de 3 hasta 1000 caracteres  (se considera cualquier carácter excepto salto de línea) ERROR 1038 -->
    <xsl:call-template name="existElement">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:AddressLine/cbc:Line El formato del Tag UBL es diferente a alfanumérico de 3 a 200 caracteres  (se considera cualquier carácter incluido espacio, sin salto de línea) 	OBSERVACION 4094 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CitySubdivisionName El formato del Tag UBL es diferente a alfanumérico de 1 a 25 caracteres  (se considera cualquier carácter incluido espacio, sin salto de línea)	OBSERVACION 4095 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName El formato del Tag UBL es diferente a alfanumérico de 1 a 30 caracteres  (se considera cualquier carácter incluido espacio, sin salto de línea)	OBSERVACION 4096 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:ID Si el Tag UBL existe, el valor del Tag UBL debe estar en el listado 	OBSERVACION 4093 -->
    <xsl:call-template name="findElementInCatalog">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:ID/@schemeAgencyName Si existe el atributo, el valor ingresado es diferente a 'PE:INEI' 	OBSERVACION 4256 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4256'"/>
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:ID/@schemeName Si existe el atributo, el valor ingresado es diferente a 'Ubigeos' 	OBSERVACION 4255 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4255'"/>
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CountrySubentity El formato del Tag UBL es diferente a alfanumérico de 1 a 30 caracteres  (se considera cualquier carácter incluido espacio, sin salto de línea)	OBSERVACION 4097 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:Distric El formato del Tag UBL es diferente a alfanumérico de 1 a 30 caracteres  (se considera cualquier carácter incluido espacio, sin salto de línea)	OBSERVACION 4098 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode Si el Tag UBL existe, el valor del Tag UBL es diferente a PE	OBSERVACION 4041 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/@listID Si existe el tag, el valor ingresado es diferente a 'ISO 3166-1'	OBSERVACION 4254 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/@listAgencyName Si existe el tag, el valor ingresado es diferente a 'United Nations Economic Commission for Europe'	OBSERVACION 4251 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4251'"/>
    ...
    <!-- /DebitNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/@listName Si existe el tag, el valor ingresado es diferente a 'Country'	OBSERVACION 4252 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4252'"/>
  ...
  <xsl:template match="cac:AccountingCustomerParty">
    <!-- numero de documento -->
    <!--<xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3090'" /><xsl:with-param name="node" select="cac:Party/cac:PartyIdentification" /><xsl:with-param name="expresion" select="count(cac:Party/cac:PartyIdentification) &gt; 1" /></xsl:call-template>-->
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID No existe el Tag UBL o es vacío ERROR 2679 -->
    <xsl:call-template name="existElement">
    ...
    <!-- /DebitNote/cac:AccountingCustomerParty/cbc:CustomerAssignedAccountID Si "Tipo de documento de identidad del adquiriente" es RUC (6), el formato del Tag UBL es diferente a numérico de 11 dígitos ERROR 2017 -->
    ...
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID No existe el Tag UBL o es vacío ERROR 2679 -->
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID El Tag UBL es diferente al listado ERROR 2016 -->
    <xsl:call-template name="existElement">
      <xsl:with-param name="errorCodeNotExist" select="'2679'"/>
      <xsl:with-param name="node" select="cac:Party/cac:PartyIdentification/cbc:ID/@schemeID"/>
    </xsl:call-template>
    ...
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeName	OBSERVACION 4255 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4255'"/>
      <xsl:with-param name="node" select="cac:Party/cac:PartyIdentification/cbc:ID/@schemeName"/>
      <xsl:with-param name="regexp" select="'^(Documento de Identidad)$'"/>
    ...
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeAgencyName	OBSERVACION 4256 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4256'"/>
      <xsl:with-param name="node" select="cac:Party/cac:PartyIdentification/cbc:ID/@schemeAgencyName"/>
      <xsl:with-param name="regexp" select="'^(PE:SUNAT)$'"/>
    ...
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeURI	OBSERVACION 4257 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName No existe el Tag UBL o es vacío ERROR 2021 -->
    <!-- /DebitNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName El formato del Tag UBL es diferente a alfanumérico de 3 hasta 1000 caracteres (se considera cualquier carácter excepto salto de línea) ERROR 2022 -->
    <xsl:call-template name="existAndRegexpValidateElement">
  ...
  <xsl:template match="cac:BillingReference">
    ...
    <!-- /DebitNote/cac:DiscrepancyResponse/cbc:ResponseCode Si tipo de nota de credito es 10 Ajustes de operaciones de exportación, y existe mas de un tag /DebitNote/cac:BillingReference/ ERROR 3194 -->
    ...
    <!-- /DebitNote/cac:BillingReference/InvoiceDocumentReference/cbc:DocumentTypeCode Si "Código de tipo de nota de Debito" es diferente de "03" (Penalidades/ otros conceptos) y la Serie del comprobante empieza con "F", el Tag UBL es diferente de "01", "12", "56", "06", "13", "15", "16", "18", "21", "37", "43", "45" y "55"	ERROR 2204 -->
    <!-- <xsl:call-template name="isTrueExpresion">
      ...
      <xsl:with-param name="expresion" select="substring($root/cbc:ID, 1, 1) = 'F' and $root/cac:DiscrepancyResponse/cbc:ResponseCode != '03' and cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text() != '01' and text() != '12' and text() != '56' and text() != '06' and text() != '13' and text() != '15' and text() != '16' and text() != '18' and text() != '21' and text() != '37' and text() != '43' and text() != '45' and text() != '55']"/>
    </xsl:call-template>-->
	<!--Versión 5 excel -->
    <!--<xsl:choose>-->
      <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si "Código de tipo de nota de dédito" es "03" (Penalidades/ otros conceptos) el formato del tag UBL puede ser, vacío ó:	- [F][A-Z0-9]{3}-[0-9]{1,8}	- (E001)-[0-9]{1,8}	- [0-9]{1,4}-[0-9]{1,8}	- [B][A-Z0-9]{3}-[0-9]{1,8}	- (EB01)-[0-9]{1,8}	- [S][A-Z0-9]{3}-[0-9]{1,8}	- [a-zA-Z0-9-]{1,20}-[0-9]{1,10}	ERROR 2205 -->
      <!-- <xsl:when test="$root/cac:DiscrepancyResponse/cbc:ResponseCode = '03'">
        ...
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode Si "Código de tipo de nota de Debito" es igual a"10" (Otros conceptos),  el valor del tag UBL puede ser vacío ó los valores del catálogo 01.	ERROR 2922 -->
      ...
      <!-- <xsl:otherwise>-->
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si "Código de tipo de nota de Debito" es diferente de "10" (Otros conceptos) y la nota Debito modifica a una factura, el formato del Tag UBL es diferente a:	- [F][A-Z0-9]{3}-[0-9]{1,8}	- (E001)-[0-9]{1,8}	- [0-9]{1,4}-[0-9]{1,8}	ERROR 2205 -->
        ...
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si "Código de tipo de nota de Debito" es diferente de "10" (Otros conceptos) y la NC modifica a una boleta de venta (tipo de comprobante =03), y el formato del Tag UBL es diferente a:	- [B][A-Z0-9]{3}-[0-9]{1,8}	- (EB01)-[0-9]{1,8}	- [0-9]{1,4}-[0-9]{1,8}	ERROR 2205 -->
        ...
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si "Código de tipo de nota de cédito" es diferente de "10" (Otros conceptos) y la NC modifica a un DAE (tipo de comprobante =14), y el formato del Tag UBL es diferente a:	- [S][A-Z0-9]{3}-[0-9]{1,8}	- [0-9]{1,4}-[0-9]{1,8}	- [0-9]{1,8} (Para caso de DAE sin serie)	ERROR 2205 -->
        ...
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si "Código de tipo de nota de cédito" es diferente de "10" (Otros conceptos) y  "Tipo del documento del documento que modifica" es "12", el formato del Tag UBL es diferente a:	- [a-zA-Z0-9-]{1,20}-[0-9]{1,10}	ERROR 2205 -->
        ...
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si "Código de tipo de nota de Debito" es diferente de "10" (Otros conceptos) y Si "Tipo del documento del documento que modifica" es "56", el valor del Tag UBL es diferente a alfanumérico (incluido el guión)	ERROR 2205 -->
        ...
        <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID Si la nota de Debito modifica un Documento autorizado (tipo de comprobante "06","13","16", "37", "43","45","24","15"), la serie de la nota de credito debe iniciar con F y el formato del Tag UBL es diferente a:	- [0-9]{1,4}-[0-9]{1,8}	- [A-Z0-9]{1,9}-[A-Z0-9]{1,20}	ERROR 2205 -->
        ...
        <xsl:if test="cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text()='06' or text()='13' or text()='15' or text()='16' or text()='18' or text()='21' or text()='37' or text()='43' or text()='45' or text()='55']">
          <!--<xsl:call-template name="existAndRegexpValidateElement"><xsl:with-param name="errorCodeNotExist" select="'2205'"/><xsl:with-param name="errorCodeValidate" select="'2205'"/><xsl:with-param name="node" select="$root/cbc:ID"/><xsl:with-param name="regexp" select="'^(([F][A-Z0-9]{3}-[0-9]{1,8}))$'"/></xsl:call-template>-->
          <xsl:call-template name="existAndRegexpValidateElement">
            <xsl:with-param name="errorCodeNotExist" select="'2205'"/>
            <xsl:with-param name="errorCodeValidate" select="'2205'"/>
            <xsl:with-param name="node" select="cac:InvoiceDocumentReference/cbc:ID"/>
        ...
        <!-- /DebitNote/cac:BillingReference/InvoiceDocumentReference/cbc:DocumentTypeCode Si "Código de tipo de nota de Debito" es diferente de "10" (Otros conceptos) y la Serie del comprobante empieza con "B", el Tag UBL es diferente de "03"	ERROR 2400 -->
    ...
    <!-- /DebitNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID El "Tipo de documento del documento que modifica" concatenado con el valor del Tag UBL no debe repetirse en el /DebitNote ERROR 2365 -->
    <xsl:call-template name="isTrueExpresion">
  ...
  <xsl:template match="cac:DespatchDocumentReference">
    <!-- /DebitNote/cac:DespatchDocumentReference/cbc:ID Si el Tag UBL existe, el formato del Tag UBL es diferente a: 	- [T][0-9]{3}-[0-9]{1,8}	- [0-9]{4}-[0-9]{1,8}	- [EG][0-9]{2}-[0-9]{1,8}	- [G][0-9]{3}-[0-9]{1,8} OBSERV 4006 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cac:DespatchDocumentReference/cbc:ID El "Tipo de la guía de remisión relacionada" concatenado con el valor del Tag UBL no debe repetirse en el /DebitNote ERROR 2364 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <!-- /DebitNote/cac:DespatchDocumentReference/cbc:DocumentTypeCode Si existe el Tag UBL, el formato del Tag UBL es diferente de "09" o "31" OBSERV 4005 -->
    <xsl:call-template name="existAndRegexpValidateElement">
  ...
  <xsl:template match="cac:AdditionalDocumentReference">
    <xsl:param name="root" select="'-'"/>
    <!-- /DebitNote/cac:AdditionalDocumentReference/cbc:ID El formato del Tag UBL es diferente a alfanumérico de entre 6 y 30 caracteres  (se considera cualquier carácter no permite "whitespace character": espacio, salto de línea, fin de línea, tab, etc.) OBSERV 4010 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cac:AdditionalDocumentReference/cbc:ID El "Tipo de otro documento relacionado" concatenado con el valor del Tag UBL, no debe repetirse en el /DebitNote ERROR 2426 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <!-- /DebitNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode El formato del Tag UBL es diferente de "04" o "05" o "99" o "01" ERROR 4009 -->
    <xsl:call-template name="existAndRegexpValidateElement">
    ...
    <!-- /DebitNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode/@schemeName Si existe el tag, el valor ingresado es diferente a 'Documentos Relacionados' <xsl:call-template name="regexpValidateElementIfExist"><xsl:with-param name="errorCodeValidate" select="'4255'"/><xsl:with-param name="node" select="cbc:DocumentTypeCode/@schemeName"/><xsl:with-param name="regexp" select="'^(Documentos Relacionados)$'"/><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode/@schemeAgencyName Si existe el tag, el valor ingresado es diferente a 'PE:SUNAT' <xsl:call-template name="regexpValidateElementIfExist"><xsl:with-param name="errorCodeValidate" select="'4256'"/><xsl:with-param name="node" select="cbc:DocumentTypeCode/@schemeAgencyName"/><xsl:with-param name="regexp" select="'^(PE:SUNAT)$'"/><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode/@schemeURI Si existe el tag, el valor ingresado es diferente a 'urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo12' <xsl:call-template name="regexpValidateElementIfExist"><xsl:with-param name="errorCodeValidate" select="'4257'"/><xsl:with-param name="node" select="cbc:DocumentTypeCode/@schemeURI"/><xsl:with-param name="regexp" select="'^(urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo12)$'"/><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
  </xsl:template>
  ...
  <xsl:template match="cac:TaxTotal" mode="cabecera">
    ...
    <!-- /DebitNote/cac:TaxTotal/cbc:TaxAmount Si el Tag UBL existe, el formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 2 decimales ERROR 3020 -->
    <xsl:call-template name="validateValueTwoDecimalIfExist">
    ...
    <!-- /DebitNote/cac:TaxTotal/cbc:TaxAmount Si el Tag UBL existe, el monto total de impuestos es diferente a la sumatoria de impuestos (Códigos 1000+1016+2000) ERROR 2519 -->
    ...
    <!-- <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'2519'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="($totalImpuestos + 1 ) &lt; $SumatoriaImpuestos or ($totalImpuestos - 1) &gt; $SumatoriaImpuestos" />            </xsl:call-template>-->
    ...
    <!-- /DebitNote/cac:TaxTotal El tag cac:TaxTotal no debe repetirse en el comprobante ERROR 3024 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:variable name="totalBaseExportacionxLinea" select="sum($root/cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9995']]/cbc:TaxableAmount)"/>
    <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:variable name="totalBaseExoneradasxLinea" select="sum($root/cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9997']]/cbc:TaxableAmount)"/>
    <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:variable name="totalBaseInafectasxLinea" select="sum($root/cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9998']]/cbc:TaxableAmount)"/>
    <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:variable name="totalBaseGratuitasxLinea" select="sum($root/cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9996']]/cbc:TaxableAmount)"/>
    <xsl:call-template name="isTrueExpresion">
    ...
    <!-- <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3196'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="($totalImpuestos + 1 ) &lt; $SumatoriaImpuestos or ($totalImpuestos - 1) &gt; $SumatoriaImpuestos" /><xsl:with-param name="isError" select ="true()"/></xsl:call-template> -->
  ...
  <xsl:template match="cac:TaxTotal/cac:TaxSubtotal" mode="cabecera">
    ...
    <!--<xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()!='9996']">/DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount No existe el Tag UBL o es vacío	ERROR 3003 -->
    <!--	<xsl:call-template name="existElement"><xsl:with-param name="errorCodeNotExist" select="'3003'"/><xsl:with-param name="node" select="cbc:TaxableAmount"/></xsl:call-template>  -->
    <!--</xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount El formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 2 decimales ERROR 2999 -->
    <!-- Antonio-->
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount si codigo de tributo es = '1000' y  el Tag UBL existe, el valor del Tag UBL es diferente a la sumatoria del total valor de venta - operaciones gravadas de IGV en cada ítem (con una tolerancia + - 1) ERROR 3039    <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='1000']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3039'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaIGVLinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaIGVLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount si codigo de tributo es = '1016' y  el Tag UBL existe, el valor del Tag UBL es diferente a la sumatoria del total valor de venta - operaciones gravadas de IGV en cada ítem (con una tolerancia + - 1) ERROR 3046  <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='1016']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3046'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaIVAPLinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaIVAPLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si codigo de tributo = '2000', Si el Tag UBL existe y el valor del Tag UBL es diferente a la sumatoria del total valor de venta  - ISC de cada ítem (con una tolerancia + - 1) ERROR 3045 <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='2000']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3045'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaISCLinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaISCLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si codigo de tributo = '9999', Si el Tag UBL existe, el valor del Tag UBL es diferente a la sumatoria del total valor de venta  - Otros tributos '9999' de cada ítem  (con una tolerancia + - 1) ERROR 3008   <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9999']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3008'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaOTRLinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaOTRLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount Si  codigo tributo es '1000', el valor del Tag Ubl es diferente de la sumatoria de los importes de IGV de cada ítem ERROR 3038 <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='1000']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3038'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxAmount) &gt; (number($totSumatoriaIGVLinea)+1) or number(cbc:TaxAmount) &lt; (number($totSumatoriaIGVLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount Si  codigo tributo es '1016', el valor del Tag Ubl es diferente de la sumatoria de los importes de IVAP de cada ítem ERROR 3049<xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='1016']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3049'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxAmount) &gt; (number($totSumatoriaIVAPLinea)+1) or number(cbc:TaxAmount) &lt; (number($totSumatoriaIVAPLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount Si  codigo tributo es '2000', el valor del Tag Ubl es diferente de la sumatoria de los importes de ISC de cada ítem (con una tolerancia + - 1) ERROR 3048  <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='2000']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3048'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxAmount) &gt; (number($totSumatoriaISCLinea)+1) or number(cbc:TaxAmount) &lt; (number($totSumatoriaISCLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount Si  codigo tributo es '9999', el valor del Tag Ubl es diferente de la sumatoria de los importes de otros tributos (9999) de cada ítem (con una tolerancia + - 1) ERROR 3009   <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9999']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3009'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxAmount) &gt; (number($totSumatoriaOTRLinea)+1) or number(cbc:TaxAmount) &lt; (number($totSumatoriaOTRLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si el codigo de tributo es = '9995', el valor del Tag UBL es diferente a la sumatoria del total valor de venta - Exportaciones de cada ítem ERROR 3040   <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9995']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3040'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaEXPLinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaEXPLinea)-1)" /></xsl:call-template></xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si el codigo de tributo es = '9996', el valor del Tag UBL es diferente a la sumatoria del total valor de venta - Exportaciones de cada ítem ERROR 3057 <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9996']"><xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3057'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaGRALinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaGRALinea)-1)" /></xsl:call-template></xsl:if>-->
    <!--<xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9997']">-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si el codigo de tributo es = '9997', el valor del Tag UBL es diferente a la sumatoria del total valor de venta - operaciones exoneradas de cada ítem  (con una tolerancia + - 1)	ERROR 3042 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3042'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaEXOLinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaEXOLinea)-1)" /></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9997" (Exonerada)  y existe alguna línea con "codigo de tributo por linea" igual a "9997" (Exonerada),  el Tag UBL es igual a 0 (cero)	OBSERVACION 4018 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4018'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="count($root/cac:DebitNote/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9997']]) > 0 and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9997" (Exonerada)  y "Código de leyenda" es 2001, el valor del Tab UBL es igual a 0 (cero)	OBSERVACION 4022 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4022'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="$root/cbc:Note/@languageLocaleID='2001' and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9997" (Exonerada) y "Código de leyenda" es 2002, el valor del Tab UBL es igual a 0 (cero)	OBSERVACION 4023 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4023'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="$root/cbc:Note/@languageLocaleID='2002' and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9997" (Exonerada) y "Código de leyenda" es 2003, el valor del Tab UBL es igual a 0 (cero)	OBSERVACION 4024  <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4024'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="$root/cbc:Note/@languageLocaleID='2003' and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9997" (Exonerada) y "Código de leyenda" es 2007, el valor del Tab UBL es igual a 0 (cero)	OBSERVACION 4243 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4243'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="$root/cbc:Note/@languageLocaleID='2007' and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9997" (Exonerada) y "Código de leyenda" es 2008, el valor del Tab UBL es igual a 0 (cero)	OBSERVACION 4244 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4244'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="$root/cbc:Note/@languageLocaleID='2008' and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!--</xsl:if>-->
    <!--<xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9998']">-->
    <!-- /CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si el codigo de tributo es = '9998', el valor del Tag UBL es diferente a la sumatoria del total valor de venta - operaciones inafectos de cada ítem  (con una tolerancia + - 1)	ERROR 3041<xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3041'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="number(cbc:TaxableAmount) &gt; (number($totValorVentaINALinea)+1) or number(cbc:TaxableAmount) &lt; (number($totValorVentaINALinea)-1)" /></xsl:call-template> -->
    <!-- /CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount Si "codigo de tributo" igual a "9998" (inafectas) y  existe alguna línea con "codigo de tributo por linea" igual a "9998" (inafectas), el Tag UBL es igual a 0 (cero)	OBSERVACION 4017 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'4017'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="count($root/cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9998']]) > 0 and number(cbc:TaxableAmount) = 0" /><xsl:with-param name="isError" select ="false()"/></xsl:call-template>-->
    <!--</xsl:if>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount El formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 2 decimales ERROR 2048 -->
    <xsl:call-template name="validateValueTwoDecimalIfExist">
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount Si el Tag UBL existe, el valor del Tag Ubl es diferente de 0 (cero), cuando el código de tributo es 9995, 9997 y 9998. 	ERROR 3000 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID No existe el Tag UBL o es vacío ERROR 3059 -->
    <xsl:call-template name="existElement">
      <xsl:with-param name="errorCodeNotExist" select="'3059'"/>
      <xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/>
    </xsl:call-template>
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID El valor del Tag UBL es diferente al código del tributo del listado ERROR 3007 -->
    <xsl:call-template name="findElementInCatalog">
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID El valor del Tag UBL no debe repetirse en el comprobante ERROR 3068 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID Si "código de tipo de nota de credito" es 12 (IVAP)  y existe un Id '9995' o '9997' o '9998' a nivel global ERROR 3221 -->
    ...
    <!--</xsl:if>-->
    <!-- /CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID Si tipo de nota de debito es 11 (Exportacion) y existe un Id '9997' o '9998' a nivel global	ERROR 3221 -->
    <xsl:call-template name="isTrueExpresion">
      <xsl:with-param name="errorCodeValidate" select="'3221'"/>
      <xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/>
    ...
    <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='1000' or text()='1016']">
      <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID Si "código de tipo de nota de credito" es 11 (IVAP) y existe un Id '1000'	ERROR 3107 -->
      <xsl:call-template name="isTrueExpresion">
      ...
      <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID si "código de tipo de nota de credito" es 10 (Exportación) y existe un ID '1000' o '1016' o  a nivel global	ERROR 3107 -->
      <xsl:call-template name="isTrueExpresion">
        <xsl:with-param name="errorCodeValidate" select="'3107'"/>
        <xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/>
    ...
    <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='2000' or text()='9999']">
      <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID Si "código de tipo de nota de credito" es 11 (IVAP)  y existe un Id '2000'	ERROR 3107 -->
      <xsl:call-template name="isTrueExpresion">
        <xsl:with-param name="errorCodeValidate" select="'3107'"/>
        <xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/>
      ...
      <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID si "código de tipo de nota de credito" es 10 (Exportación) y existe un ID '2000' o '9999' a nivel global	ERROR 3107 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3107'" /><xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:ID" /><xsl:with-param name="expresion" select="$root/cac:DiscrepancyResponse/cbc:ResponseCode = '10' and cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='2000' or text()='9999']" /><xsl:with-param name="isError" select ="true()"/></xsl:call-template>-->
    </xsl:if>
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID si "código de tipo de nota de credito" es 11 (Exportación) y  '9997' o '9998' en cualquier invoice line OBSERV 3107 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3107'" /><xsl:with-param name="node" select="cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID" /><xsl:with-param name="expresion" select="$root/cac:DiscrepancyResponse/cbc:ResponseCode = '11' and (cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID ='9997' or cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID ='9998')" /><xsl:with-param name="isError" select ="true()"/></xsl:call-template>-->
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name No existe el Tag UBL o es vacío ERROR 2054 -->
    <xsl:call-template name="existElement">
      <xsl:with-param name="errorCodeNotExist" select="'2054'"/>
      <xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:Name"/>
    </xsl:call-template>
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name Si el tag es diferente al nombre del tributo del listado según el codigo del tributo. (catalogo 5) ERROR 2964 -->
    <!--<xsl:call-template name="findElementInCatalogProperty"><xsl:with-param name="catalogo" select="'05'"/><xsl:with-param name="propiedad" select="'name'"/><xsl:with-param name="idCatalogo" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/><xsl:with-param name="valorPropiedad" select="cac:TaxCategory/cac:TaxScheme/cbc:Name"/><xsl:with-param name="errorCodeValidate" select="'2964'"/><xsl:with-param name="descripcion" select="concat('Error Tributo ', $codigoTributo)"/></xsl:call-template>-->
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode No existe el Tag UBL o es vacío ERROR 2052 -->
    <xsl:call-template name="existElement">
    ...
    <!-- /DebitNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode Si el tag es diferente al codigo internacional del tributo del listado según el codigo del tributo. (catalogo 5) ERROR 2961 -->
    <!--<xsl:call-template name="findElementInCatalogProperty"><xsl:with-param name="catalogo" select="'05'"/><xsl:with-param name="propiedad" select="'UN_ECE_5153'"/><xsl:with-param name="idCatalogo" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/><xsl:with-param name="valorPropiedad" select="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode"/><xsl:with-param name="errorCodeValidate" select="'2961'"/></xsl:call-template>-->
  </xsl:template>
  ...
  <xsl:template match="cac:DebitNoteLine">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cbc:ID El formato del Tag UBL es diferente de numérico de hasta 3 dígitos; o, es igual cero.	ERROR 2137 -->
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cbc:ID El valor del Tag UBL no debe repetirse en el /DebitNote	ERROR 2752 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cbc:DebitedQuantity@unitCode NSi el Tag UBL existe, no existe el atributo del Tag UBL	ERROR 2138 -->
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cbc:DebitedQuantity@unitCodeListID Si existe el tag, el valor ingresado es diferente a 'UN/ECE rec 20'	ERROR 4258 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cbc:DebitedQuantity@unitCodeListAgencyName Si existe el tag, el valor ingresado es diferente a 'United Nations Economic Commission for Europe'	ERROR 4259 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cbc:DebitedQuantity No existe el Tag UBL	ERROR 2580 -->
    <!-- /DebitNote/cac:DebitNoteLine/cbc:DebitedQuantity Si el Tag UBL existe, el formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 10 decimales	ERROR 2139 -->
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cac:SellersItemIdentification/cbc:ID Si el tag UBL existe,  el formato del Tag UBL es diferente a alfanumérico de 1 hasta 50 caracteres (se considera cualquier carácter excepto salto de línea)	OBSERVACION 4234 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode Si el tag UBL existe y el código de tipo de nota de Debito es 10, el valor del Tag UBL es vacío	ERROR 3001 -->
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode Si el tag UBL existe y el código de tipo de nota de Debito es 10, el valor del Tag UBL no se encuentra en el listado	ERROR 3002 -->
    <!--          <xsl:if test="$root/cac:DiscrepancyResponse/cbc:ResponseCode = '11'"> -->
    <!--         	<xsl:call-template name="existElement"> -->
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode@listID Si existe el tag, el valor ingresado es diferente a 'UNSPSC'	ERROR 4254 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4254'"/>
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode@listAgencyName Si existe el tag, el valor ingresado es diferente a 'GS1 US'	ERROR 4251 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4251'"/>
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode@listName Si existe el tag, el valor ingresado es diferente a 'Item Classification'	ERROR 4252 -->
    <xsl:call-template name="regexpValidateElementIfExist">
      <xsl:with-param name="errorCodeValidate" select="'4252'"/>
    ...
    <xsl:choose>
      <xsl:when test="cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID = 'GTIN-8'">
        <xsl:call-template name="regexpValidateElementIfExist">
          ...
          <xsl:with-param name="regexp" select="'^((?!\s*$)[\s\S]{8})$'"/>
          <!-- Texto de un caracter a 14. acepta saltos de linea, no permite que inicie con espacios -->
          <xsl:with-param name="isError" select="false()"/>
      ...
      <xsl:when test="cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID = 'GTIN-12'">
        <xsl:call-template name="regexpValidateElementIfExist">
          <xsl:with-param name="errorCodeValidate" select="'4334'"/>
          <xsl:with-param name="node" select="cac:Item/cac:StandardItemIdentification/cbc:ID"/>
          <xsl:with-param name="regexp" select="'^((?!\s*$)[\s\S]{12})$'"/>
          <!-- Texto de un caracter a 14. acepta saltos de linea, no permite que inicie con espacios -->
          <xsl:with-param name="isError" select="false()"/>
          <xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Formato ', cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID )"/>
        </xsl:call-template>
      ...
      <xsl:when test="cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID = 'GTIN-13'">
        <xsl:call-template name="regexpValidateElementIfExist">
          ...
          <xsl:with-param name="errorCodeValidate" select="'4334'"/>
          <xsl:with-param name="node" select="cac:Item/cac:StandardItemIdentification/cbc:ID"/>
          <xsl:with-param name="regexp" select="'^((?!\s*$)[\s\S]{13})$'"/>
          <!-- Texto de un caracter a 14. acepta saltos de linea, no permite que inicie con espacios -->
          <xsl:with-param name="isError" select="false()"/>
          <xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Formato ', cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID )"/>
        </xsl:call-template>
      ...
      <xsl:when test="cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID = 'GTIN-14'">
        <xsl:call-template name="regexpValidateElementIfExist">
          ...
          <xsl:with-param name="errorCodeValidate" select="'4334'"/>
          <xsl:with-param name="node" select="cac:Item/cac:StandardItemIdentification/cbc:ID"/>
          <xsl:with-param name="regexp" select="'^((?!\s*$)[\s\S]{14})$'"/>
          <!-- Texto de un caracter a 14. acepta saltos de linea, no permite que inicie con espacios -->
          <xsl:with-param name="isError" select="false()"/>
          <xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Formato ', cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID )"/>
        </xsl:call-template>
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Item/cbc:Description Si el tag UBL existe,  el formato del Tag UBL es diferente a alfanumérico de 3 hasta 500 caracteres (se considera cualquier carácter excepto salto de línea)	ERROR 4084 -->
    <xsl:call-template name="regexpValidateElementIfExist">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Price/cbc:PriceAmount Si el Tag UBL existe, el formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 10 decimales	ERROR 4254 -->
    <xsl:call-template name="existAndValidateValueTenDecimal">
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:Price/cbc:PriceAmount Si "Código de tipo de precio" es 02 (Gratuitas), el valor del Tag UBL es mayor a 0 (cero)	ERROR 2640 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:for-each select="cac:PricingReference/cac:AlternativeConditionPrice">
      <!-- cac:DebitNoteLine/cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceAmount No existe el Tag UBL ERROR 2028 -->
      <!-- cac:DebitNoteLine/cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceAmount El formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 10 decimales  ERROR 2367     <xsl:call-template name="existAndValidateValueTenDecimal"><xsl:with-param name="errorCodeNotExist" select="'2028'"/> <xsl:with-param name="errorCodeValidate" select="'2367'"/><xsl:with-param name="node" select="cbc:PriceAmount"/><xsl:with-param name="isGreaterCero" select="false()"/><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/></xsl:call-template>    -->
      <xsl:if test="cbc:PriceAmount">
        ...
        <!--<xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'2367'" /><xsl:with-param name="node" select="cbc:PriceAmount" /><xsl:with-param name="expresion" select="cbc:PriceAmount != 0" /><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/></xsl:call-template>-->
      </xsl:if>
      <xsl:call-template name="existElement">
      ...
      <!--<xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'2409'" /><xsl:with-param name="node" select="cbc:PriceTypeCode" /><xsl:with-param name="expresion" select="count(cbc:PriceTypeCode) &gt; 1" /><xsl:with-param name="descripcion" select="concat('Error en la linea:', position(), '. ')"/></xsl:call-template>-->
      <xsl:call-template name="regexpValidateElementIfExist">
        <xsl:with-param name="errorCodeValidate" select="'4252'"/>
    ...
    <!-- /DebitNote/cac:DebitNoteLine/cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceAmount Si 	Si "Afectación al IGV por línea" es 10 (Gravado), 20 (Exonerado) o 30 (Inafecto) y "Código de precio" es 02 (Valor referencial en operaciones no onerosa), el Tag UBL es mayor a 0 (cero)	ERROR 2425 -->
    ...
    <!-- Si el Tag UBL existe, el monto total de impuestos por línea es diferente a la sumatoria de impuestos por línea <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3022'" /><xsl:with-param name="node" select="cac:TaxTotal/cbc:TaxAmount" /><xsl:with-param name="expresion" select="($totalImpuestosxLinea + 1 ) &lt; $SumatoriaImpuestosxLinea or ($totalImpuestosxLinea - 1) &gt; $SumatoriaImpuestosxLinea" /><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/></xsl:call-template>-->
    ...
    <!-- FIN Validacion 4288 -->
    <!-- /DebitNote/cac:DebitNoteLine/cbc:LineExtensionAmount El formato del Tag UBL es diferente de decimal positivo de 12 enteros y hasta 2 decimales	ERROR 2370 -->
    <xsl:call-template name="existAndValidateValueTwoDecimal">
  ...
  <xsl:template match="cac:TaxSubtotal" mode="linea">
    ...
    <xsl:if test="$codigoTributo = '7152'">
      <xsl:call-template name="existAndRegexpValidateElement">
        ...
        <!-- enteros mayores a cero y hasta 5 digitos -->
        <xsl:with-param name="regexp" select="'^([0-9]{1,5})?$'"/>
        <!-- enteros mayores o iguales a cero y hasta 5 digitos -->
        <xsl:with-param name="descripcion" select="concat('Error en la linea:', position(), '. ')"/>
      </xsl:call-template>
    </xsl:if>
    <!-- PAS20191U210000012 -->
    ...
    <!-- 3222 Tag ubl > 0 and no exista un TaxableAmount  del mismo tributo > 0  <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'3222'" /><xsl:with-param name="node" select="cbc:TaxableAmount" /><xsl:with-param name="expresion" select="cbc:TaxableAmount &gt; 0 and not($root/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = $codigoTributo and cbc:TaxableAmount &gt; 0])" /><xsl:with-param name="expresion" select="cbc:TaxableAmount &gt; 0 and ($root/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = $codigoTributo]/cbc:TaxableAmount &gt; 0)" /><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Tributo: ', $codigoTributo)"/></xsl:call-template>-->
    ...
    <xsl:if test="$codigoTributo != '7152'">
      <xsl:if test="$codigoTributo != '2000' and $codigoTributo != '9999' and cbc:TaxableAmount &gt; 0">
        ...
        <!--  El valor del Tag UBL es diferente al listado segun el codigo de tributo	ERROR 2378 -->
        <!-- <xsl:call-template name="findElementInCatalogProperty"><xsl:with-param name="catalogo" select="'07'"/><xsl:with-param name="propiedad" select="$codTributo"/><xsl:with-param name="idCatalogo" select="cac:TaxCategory/cbc:TaxExemptionReasonCode"/><xsl:with-param name="valorPropiedad" select="'1'"/><xsl:with-param name="errorCodeValidate" select="'2040'"/><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Tributo: ', $codigoTributo)"/></xsl:call-template>-->
      </xsl:if>
    </xsl:if>
    ...
    <!-- Codigo de tributo por linea, el valor del Tag UBL es diferente al listado  ERROR 2038 y 2996-->
    <!--<xsl:choose><xsl:when test="$codigoTributo = '2000' or $codigoTributo = '9999'">	<xsl:call-template name="existElement"><xsl:with-param name="errorCodeNotExist" select="'2038'"/><xsl:with-param name="node" select="cac:TaxCategory/cac:TaxScheme/cbc:Name"/><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Tributo: ', $codigoTributo)"/></xsl:call-template></xsl:when><xsl:otherwise>-->
    <xsl:call-template name="existElement">
    ...
    <!--  El valor del Tag UBL es diferente al listado segun el codigo de tributo ERROR 3051 -->
    <!-- <xsl:call-template name="findElementInCatalogProperty"><xsl:with-param name="catalogo" select="'05'"/><xsl:with-param name="propiedad" select="'name'"/><xsl:with-param name="idCatalogo" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/><xsl:with-param name="valorPropiedad" select="cac:TaxCategory/cac:TaxScheme/cbc:Name"/><xsl:with-param name="errorCodeValidate" select="'3051'"/><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Tributo: ', $codigoTributo)"/></xsl:call-template>-->
    <!--  El valor del Tag UBL es diferente al listado segun el codigo de tributo ERROR 2378 -->
    <!-- <xsl:call-template name="findElementInCatalogProperty"><xsl:with-param name="catalogo" select="'05'"/><xsl:with-param name="propiedad" select="'UN_ECE_5153'"/><xsl:with-param name="idCatalogo" select="cac:TaxCategory/cac:TaxScheme/cbc:ID"/><xsl:with-param name="valorPropiedad" select="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode"/><xsl:with-param name="errorCodeValidate" select="'2377'"/><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Tributo: ', $codigoTributo)"/></xsl:call-template>-->
  </xsl:template>
  ...
  <xsl:template match="cac:TaxTotal" mode="linea">
    ...
    <xsl:variable name="tipoNotaDebito" select="$root/cac:DiscrepancyResponse/cbc:ResponseCode"/>
    <!-- cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount No existe el Tag UBL o es diferente al Tag anterior  ERROR 2372 <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'2372'" /><xsl:with-param name="node" select="cbc:TaxAmount" /><xsl:with-param name="expresion" select="number(cac:TaxSubtotal/cbc:TaxAmount) != number(cbc:TaxAmount)" /><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/></xsl:call-template>-->
    <!-- El formato del Tag UBL es diferente de decimal de 12 enteros y hasta 2 decimales   ERROR   2033 <xsl:call-template name="existAndValidateValueTwoDecimal"><xsl:with-param name="errorCodeNotExist" select="'3021'"/><xsl:with-param name="errorCodeValidate" select="'3021'"/><xsl:with-param name="node" select="cbc:TaxAmount"/><xsl:with-param name="isGreaterCero" select="false()"/><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/></xsl:call-template>-->
    ...
    <!-- <xsl:call-template name="isTrueExpresion"><xsl:with-param name="errorCodeValidate" select="'2644'" /><xsl:with-param name="node" select="cac:TaxSubtotal/cac:TaxCategory[cbc:TaxExemptionReasonCode!='17']/cbc:TaxExemptionReasonCode" /><xsl:with-param name="expresion" select="cac:TaxSubtotal[cac:TaxCategory/cbc:TaxExemptionReasonCode='17']/cbc:TaxableAmount &gt; 0 and cac:TaxSubtotal[cac:TaxCategory/cbc:TaxExemptionReasonCode!='17' and cac:TaxCategory/cac:TaxScheme/cbc:ID[text() != '2000' or text()= '9999']]/cbc:TaxableAmount &gt; 0" /><xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/></xsl:call-template>-->
    <!--Versión 5 excel -->
	<!--Excel v6 PAS20211U210400011 JRGS - Se elimina la validación 3100 por redundancia-->
	<!--<xsl:if test="$tipoNotaDebito = '11'">
      <xsl:call-template name="isTrueExpresion">
        <xsl:with-param name="errorCodeValidate" select="'3100'"/>
        <xsl:with-param name="node" select="cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '1000' or text() = '1016' or text() = '2000' or text() = '9997' or text() = '9998' or text() = '9999']"/>
    ...
    <!-- Si "Tipo de operación" es Exportación, el valor del Tag UBL es igual a 1000, 1016, 9997, 9998, 9999, 2000 (Exportación)  ERROR 3105 -->
    <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:if test="count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) &gt; 1">
      <xsl:call-template name="isTrueExpresion">
        ...
        <xsl:with-param name="expresion" select="not((cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '1000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                            (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '1000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                            (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '1000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 3) or                            (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '1016' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                            (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9995' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                            (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9996' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9996' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 3) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9996' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9997' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9997' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 3) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9997' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9998' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2)or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9998' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '2000' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 3) or                             (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9998' and cbc:TaxableAmount &gt; 0] and cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '9999' and cbc:TaxableAmount &gt; 0] and count(cac:TaxSubtotal[cbc:TaxableAmount &gt; 0]) = 2))"/>
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template match="cac:Item/cac:AdditionalItemProperty" mode="linea">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$codigoConcepto = '7003'">
		...
		<!--Excel v6 PAS20211U210400011 JRGS - Se agrega modifica validacion OBS-4280 -->
        <!--<xsl:call-template name="regexpValidateElementIfExist">
          <xsl:with-param name="errorCodeValidate" select="'4280'"/>
          <xsl:with-param name="node" select="cbc:Value"/>
      ...
      <xsl:when test="$codigoConcepto = '7005'">
        ...
        <xsl:call-template name="regexpValidateElementIfExist">
          ...
          <xsl:with-param name="regexp" select="'^2[0-9]{3}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$'"/>
